...
| 产品壳层 | 桌面端采用左侧工作台，支持最近问诊、搜索记录、健康档案、记录中心与用药建议一处切换，并增加壳层异常兜底与次级面板按需加载 |
...
| 工具与检索 | 支持天气、医院、知识库、官方资料与联网检索降级策略，并在网络异常时给出更清晰的失败回退提示 |
| 导出与分享 | 支持就诊报告 PDF 导出、健康档案 PDF 导出与近期健康摘要分享 |
| 终端体验 | 支持语音输入、图片辅助上下文、PWA 安装、离线 / 恢复提示、错误边界兜底与移动端使用 |
